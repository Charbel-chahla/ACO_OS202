...
ALL= ant_simu.exe ant_simu_vec.exe ant_simu_omp.exe ant_simu_soa_omp.exe ant_simu_mpi.exe
...
ant_simu_soa_omp.exe : fractal_land.o ant_simu_soa_omp.o
	$(CXX) $(CXXFLAGS2) $^ -o $@ $(LIB)

ant_simu_mpi.o: ant_simu_mpi.cpp
	$(MPICXX) $(CXXFLAGS2) -c $< -o $@

ant_simu_mpi.exe : fractal_land.o ant_vec.o ant_simu_mpi.o
	$(MPICXX) $(CXXFLAGS2) $^ -o $@
