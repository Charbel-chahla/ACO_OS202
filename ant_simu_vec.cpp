...
// SoA : layout favorable à la vectorisation automatique
struct ants_soa {
    std::vector<int>          x;
    std::vector<int>          y;
...
int main(int argc, char* argv[])
{
    ...
    // =========================================================
    // SETUP : normalisation
    // Bug corrigé : 0.0 → numeric_limits (faux si terrain entièrement > 0)
    // =========================================================
    t0 = sim_clock::now();
    ...
    std::cout << "\n===== Timing summary SOA (" << max_iterations << " iterations) =====\n";
